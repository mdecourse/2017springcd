...
Category: Course
Tags: Brython, spur, gear
Slug: brython-spur-gears
Author: yen

利用 <a href="https://github.com/brython-dev/brython/releases/tag/3.3.1">Brython 3.3.1</a> 執行 3 個正齒輪傳動繪圖.
...
請各組以協同方式利用 2D 與 3D 繪圖設計方法, 完成行走機構所需齒輪減速組合之分析、模擬與製作.

<a href="./../GearSketch/index.html">GearSketch</a> (source: <a href="http://modeldrawing.eu/our-software/gearsketch/">http://modeldrawing.eu/our-software/gearsketch/</a> & <a href="https://github.com/frankleenaars/gearsketch">https://github.com/frankleenaars/gearsketch</a>)